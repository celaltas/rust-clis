...
pub fn get_args() -> MyResult<Config> {
    ...
    let byte_args = Arg::with_name("bytes")
        .short("b")
        .long("bytes")
        .help("Selected bytes")
        .takes_value(true)
    ...
    let char_args = Arg::with_name("chars")
        .short("c")
        .long("chars")
    ...
    let delim_args = Arg::with_name("delim")
    ...
    let field_args = Arg::with_name("fields")
        .short("f")
        .long("fields")
